...
function carregarSom(caminhoArquivo, volume = 1.0, loop = false) {
  ...
  try {
    ...
    audio.addEventListener('error', (e) => {
      ...
      console.error(`Mensagem: ${audio.error ? audio.error.message : 'desconhecido'}`);
    });
          ...
          playPromise
            ...
            .catch(e => {
              ...
              if (e.name === 'NotAllowedError') {
                console.warn('Reprodução automática bloqueada pelo navegador. Necessária interação do usuário.');
              }
            });
        }
      },
    ...
    console.error(`Exceção ao criar objeto de áudio para ${caminhoArquivo}:`, error);
    // Retornar um objeto nulo que não faz nada quando chamado
    return {
      elemento: null,
      reproduzir: () => console.warn(`Áudio ${caminhoArquivo} não pode ser reproduzido`),
      pausar: () => {},
      parar: () => {},
      definirVolume: () => {},
      definirLoop: () => {},
...
function mostrarTelaPermissaoAudio() {
  ...
  botaoAtivar.addEventListener("click", function() {
    ...
    audioDesbloqueio.src = "data:audio/mp3;base64,";
