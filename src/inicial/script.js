...
function criarInterface() {
  ...
  pSobre.innerHTML = 'Jogo criado em parceria com a <b>Google for Education</b>';
  ...
  pDesenvolvedores.textContent = 'André Katz, Celso Rocha, Daniel Meiches, Kaian Santos, Luiz Fernando, Miguel Almeida, Wendel';
...
function animarTeclaInteracao() {
  ...
  const intervalId = setInterval(() => {
    ...
    if (!document.getElementById(interactionKeys[0]) && !document.getElementById(interactionKeys[1])) {
      clearInterval(intervalId);
      return;
    }
