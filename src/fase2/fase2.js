...
function removePhase1HUDs() {
  ...
  oldStyles.forEach((style) => {
    if (
      style.textContent.includes("keycard-container") ||
...
let questions2 = [
  {
    question:
      "📱Você finalmente decidiu comprar aquele celular dos seus sonhos e encontrou um bom preço em uma loja virtual. Na hora de se cadastrar, a loja solicita seu CPF para finalizar a compra. Isso está certo ou errado?",
    answer: true,
    feedback:
      "A solicitação do CPF pode ser justificada para a emissão da nota fiscal e para evitar fraudes, conforme permitido pela LGPD. No entanto, a loja deve informar de forma clara o motivo da coleta desse dado e garantir sua segurança. Se o CPF for solicitado sem justificativa válida, pode ser considerado um excesso na coleta de dados.",
  },
  {
    question:
      "📶 Você está passeando no shopping e decide usar o Wi-Fi gratuito para economizar seu plano de dados. Ao tentar se conectar, a rede pede obrigatoriamente que você informe seu nome, telefone e data de nascimento antes de liberar o acesso. Isso está certo ou errado?",
    answer: false,
    feedback:
      "Embora o shopping possa coletar alguns dados para fins de segurança ou marketing, a LGPD exige que isso seja feito de forma transparente e proporcional. Pedir nome, telefone e data de nascimento pode ser considerado uma coleta excessiva, principalmente se não houver uma explicação clara sobre o uso dessas informações. Além disso, o usuário deve ter a opção de negar a coleta e ainda assim poder acessar o serviço.",
  },
  {
    question:
      "📰 Você está navegando em um site de notícias quando aparece um pop-up oferecendo descontos exclusivos para assinantes da newsletter. Para se inscrever, o site solicita seu e-mail. Isso está certo ou errado?",
    answer: true,
    feedback:
      "Pedir o e-mail para assinatura de uma newsletter é uma prática comum e legítima, desde que o site informe claramente a finalidade do uso do dado e obtenha seu consentimento. Além disso, a LGPD exige que o usuário tenha a opção de cancelar a assinatura a qualquer momento.",
  },
  {
    question:
      "💼 Você se candidatou a uma vaga de emprego e, durante o processo seletivo, a empresa pede que você informe sua religião e orientação política. Isso está certo ou errado?",
    answer: false,
    feedback:
      "De acordo com a LGPD, informações sobre religião e orientação política são dados sensíveis, ou seja, exigem um nível maior de proteção e só podem ser coletados em situações extremamente específicas e justificadas por lei. No contexto de uma entrevista de emprego, essa solicitação não é relevante para a contratação e pode ser considerada uma violação da privacidade do candidato.",
  },
  {
    question:
      "📲 Você baixou um novo aplicativo de rede social e, ao criar sua conta, ele solicita obrigatoriamente o acesso à sua lista de contatos para 'ajudar a encontrar amigos'. Isso está certo ou errado?",
    answer: false,
    feedback:
      "Embora a funcionalidade possa ser útil, a LGPD exige que o aplicativo informe de forma clara para que os contatos serão usados, se serão armazenados e com quem serão compartilhados. Além disso, o usuário deve ter a opção de negar o acesso e ainda assim usar o aplicativo normalmente. Se o app exigir essa permissão sem alternativa, pode estar infringindo a lei.",
  },
  {
    question:
      "📲 Você baixou um aplicativo de anotações e, ao abrir, ele pede permissão para acessar sua câmera. Isso está certo ou errado?",
    answer: false,
    feedback:
      "Se o app de anotações não tem funcionalidades que justifiquem o uso da câmera, essa solicitação pode ser considerada uma coleta de dados desnecessária, indo contra a LGPD. O aplicativo deve solicitar apenas os dados estritamente necessários para sua funcionalidade.",
  },
  {
    question:
      "🎮 Você baixou um jogo no celular e, ao abrir pela primeira vez, ele pede permissão para acessar o microfone, mesmo sem ter chat por voz. Isso está certo ou errado?",
    answer: false,
    feedback:
      "Se o jogo não tem nenhuma função que use o microfone, não faz sentido ele pedir essa permissão. A LGPD diz que aplicativos só devem coletar dados necessários para o seu funcionamento. Pode ser um sinal de que o jogo está coletando mais informações do que deveria!",
  },
  {
    question:
      "📱 Você criou uma conta em uma rede social nova e, antes de começar a usar, ela pede sua data de nascimento. Isso está certo ou errado?",
    answer: true,
    feedback:
      "As redes sociais precisam saber sua idade para garantir que você pode usá-las de acordo com a lei. Algumas plataformas têm restrições para menores de idade, e a LGPD protege crianças e adolescentes de exposições indevidas na internet.",
  },
  {
    question:
      "🎥 Você gosta de assistir vídeos online, mas percebe que a plataforma sempre recomenda conteúdos parecidos com o que você assistiu antes. Isso significa que ela está coletando seu histórico de vídeos. Isso está certo ou errado?",
    answer: true,
    feedback:
      "A plataforma pode usar seu histórico para sugerir vídeos melhores para você. Mas, pela LGPD, ela deve avisar que está coletando esses dados e permitir que você apague seu histórico ou controle o que pode ser armazenado.",
  },
  {
    question:
      "🎤 Você quer participar de um concurso de talentos online e, para se inscrever, o site pede seu endereço completo. Isso está certo ou errado?",
    answer: false,
    feedback:
      "Para um concurso online, pedir o endereço pode ser um excesso. A LGPD diz que só se deve coletar informações realmente necessárias. Se não houver envio de prêmios físicos, essa informação não deveria ser solicitada.",
  },
];
...
function preloadMain2() {
  ...
  this.load.image(
    ...
    "assets/fase2/5_Classroom_and_library_32x32.png"
  );
...
function createMain2() {
  try {
    ...
    const tileset1 = map2.addTilesetImage(
      "5_Classroom_and_library_32x32",
      "5_Classroom_and_library_32x32",
      32,
      32
    ...
    const tileset3 = map2.addTilesetImage(
      "Room_Builder_32x32",
      "Room_Builder_32x32",
      32,
      32
    ...
    if (keys2Collected >= 4) {
      ...
      script.onerror = (error) => {
        ...
        loadingMsg.textContent =
          "Erro ao carregar o minigame. Tente novamente.";
...
function handleAnswer2(playerAnswer, correctAnswer, questionObj) {
  console.log(
    `Button clicked: ${playerAnswer}, correct answer: ${correctAnswer}`
  );
  ...
  const button = playerAnswer
    ? minigameContainer2.trueBtn
    : minigameContainer2.falseBtn;
  ...
  this.time.delayedCall(500, () => {
    ...
    const feedbackBoxColor =
      playerAnswer === correctAnswer ? 0x006600 : 0x660000;
    minigameContainer2.feedbackBox.setFillStyle(feedbackBoxColor);

    // Show result text with appropriate message
    minigameContainer2.resultText.setText(
      playerAnswer === correctAnswer ? "VOCÊ ACERTOU!" : "VOCÊ ERROU!"
    );
    minigameContainer2.resultText.setFill(
      playerAnswer === correctAnswer ? "#00ff00" : "#ff0000"
    );
...
function createMinigameElements2() {
  ...
  const questionText = this.add
    .text(this.cameras.main.width / 2, this.cameras.main.height / 2 - 80, "", {
      fontSize: "16px",
      fill: "#ffffff",
      wordWrap: { width: 500 },
      align: "center",
  ...
  const trueText = this.add
    .text(trueBtn.x, trueBtn.y, "CERTO", {
      fontSize: "18px",
      fill: "#ffffff",
    })
    .setOrigin(0.5);
  ...
  const falseText = this.add
    .text(falseBtn.x, falseBtn.y, "ERRADO", {
      fontSize: "18px",
      fill: "#ffffff",
    })
    .setOrigin(0.5);
  ...
  const feedbackText = this.add
    .text(this.cameras.main.width / 2, this.cameras.main.height / 2 - 30, "", {
      fontSize: "14px",
      fill: "#ffffff",
      wordWrap: { width: 500 },
      align: "center",
  ...
  const continueText = this.add
    .text(continueBtn.x, continueBtn.y, "CONTINUAR", {
      fontSize: "18px",
      fill: "#ffffff",
    })
    .setOrigin(0.5);
...
function createTutorialElements2() {
  ...
  tutorialContainer2 = this.add.container(
    this.cameras.main.centerX,
    this.cameras.main.centerY
  );
  ...
  const zeladorImage = this.add.image(panelWidth * 0.25, 0, "zelador");
  ...
  const nextBtn = this.add.rectangle(0, panelHeight * 0.35, 180, 50, 0x3854a8);
  ...
  this.scale.on("resize", () => {
    tutorialContainer2.setPosition(
      this.cameras.main.centerX,
      this.cameras.main.centerY
    );
...
function advanceTutorial2() {
  ...
  this.tweens.add({
    targets: [
      currentText,
      textBox,
      tutorialContainer2.zeladorImage,
      tutorialContainer2.zeladorBorder,
    ],
    alpha: 0,
    duration: 300,
    ease: "Power2",
...
(function () {
  ...
  let selectedCharacter =
    localStorage.getItem("selectedCharacter") || "player1";
  ...
  function create() {
    ...
    this.add
      .rectangle(0, 0, window.innerWidth, window.innerHeight, 0x222222)
      .setOrigin(0, 0);
    this.add
