...
Pensando na dor do parceiro, foi desenvolvido um jogo 2D de RPG, visando educar alunos e professores de escolas públicas sobre o que é e sobre a importância da LGPD. Tendo em mente que parte do nosso público nunca teve contato com esse tema, buscamos alinhar uma solução didática, divertida e imersiva, pois sabemos que o tema da LGPD é algo denso, então precisávamos buscar uma forma de educar as crianças com um jogo que as entretessem ao mesmo tempo que as educassem. O projeto foi construído buscando estar alinhada com os valores da Google for Eduation, valorizando a interatividade, a diversidade e a valorização do ambiente escolar. O nosso produto gera seu valor no mercado ao juntar uma proposta com didática eficiente com a diversão, pois todas as fases do jogo foram elaboradas visando a imersão e conscientização do aluno ou do professor, da seguinte maneira: No começo do jogo o jogador será apresentado aos conceitos básicos da LGPD e ao decorrer da fase terá esses conhecimentos testados, buscando a fixação do conteúdo, ao decorrer do jogo as informações serão mais profundas e serão sempre "testadas" através de minigames para que o aluno não só aprenda mas também bote em prática alguns dos conceitos.
